        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('admin/users/edit/'.$user->id) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email" style="text-transform: lowercase">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="phone" type="text" class="form-control" name="phone"  required autocomplete="new-password" value="{{ $user->phone }}">
